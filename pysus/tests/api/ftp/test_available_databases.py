...
import pysus
from pysus.api.ftp import Database
...
class TestAvailableDatabases(unittest.TestCase):
    ...
    def test_expected_databases_present(self):
        ...
        actual_databases = {
            db_class.__name__ for db_class in pysus.api.ftp.AVAILABLE_DATABASES
        }
        self.assertEqual(
            expected_databases,
            actual_databases,
